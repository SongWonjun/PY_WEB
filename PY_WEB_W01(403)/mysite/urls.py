...
urlpatterns = [
    ...
    url(r'^bookmark/update/(?P<pk>\d+)/$', BookmarkUV.as_view(), name='bookmark_update'),
    url(r'^bookmark/delete/(?P<pk>\d+)/$', BookmarkRV.as_view(), name='bookmark_delete'),
    ...
    url(r'^blog/update/(?P<pk>\d+)/$', PostUV.as_view(),name='blog_update'),
    url(r'^blog/delete/(?P<pk>\d+)/$', PostRV.as_view(),name='blog_delete'),
